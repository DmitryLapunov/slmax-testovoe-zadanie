...
enum Constants {
    ...
    enum Note {
        ...
        static let arrowTrailing: CGFloat = -13
    ...
    enum TextFields {
        ...
        static let titleFieldTop: CGFloat = 13
        static let titleFieldLeading: CGFloat = 17
        static let titleFieldTrailing: CGFloat = -27
        static let separatorTop: CGFloat = 3
        ...
        static let descriptionBottom: CGFloat = -15
        static let buttonTop: CGFloat = 4
